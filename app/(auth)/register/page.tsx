    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 md:p-12 bg-orange-50/30 relative overflow-hidden font-['Plus_Jakarta_Sans']">
            ...
            <div className="max-w-6xl w-full grid md:grid-cols-2 bg-white/80 backdrop-blur-md rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(251,146,60,0.15)] overflow-hidden min-h-[750px] border border-white">
                ...
                <div className="flex flex-col p-6 md:p-8 lg:p-20 justify-center bg-white">
                    <div className="max-w-md w-full mx-auto">
                        ...
                        <div className="mb-10">
                            <h1 className="text-4xl font-black text-colorBlack mb-3 tracking-tight">Tạo tài khoản</h1>
                            <p className="text-colorGray font-medium leading-relaxed">Nhập thông tin của bạn để bắt đầu mua hàng</p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <ButtonAuth />
                            <p className="text-center text-slate-400 text-sm font-medium">Bạn đã có tài khoản? <Link href={ROUTE.LOGIN} className="text-colorOrange font-medium text-[17px] hover:text-rose-500 transition-all ml-1">Đăng nhập</Link></p>
                        </div>
